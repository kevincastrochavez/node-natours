...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot Password? Submit a PATCH request with your new password and passwordConfirm to : ${resetURL}. If you did not forget your password, please ignore this email`;
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // SET NEW PASSWORD IF TOKEN NOT EXPIRED AND THERE'S USER
  if (!user) {
